...
import 'package:dutymate/models/todo.dart';
import 'package:dutymate/repository/database_creator.dart';
import 'package:dutymate/repository/repository_service_todo.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SqfLiteCrud(title: 'DutyMate ToDo App'),
    );
  }
}
